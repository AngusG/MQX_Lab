...
//extern const LWEVENT_STRUCT lwevent_group;
extern LWEVENT_STRUCT lwevent_group;
...
void TSI_Init(void)
{
  ...
  _nvic_int_init(INT_TSI0, 4, TRUE);
  /***********************/
...
void TSI_isr(pointer isr)
{
  ...
  {
	  _lwevent_set(&lwevent_group, TOUCH1_EVENT); //Set event bit
  ...
  {
	  _lwevent_set(&lwevent_group, TOUCH2_EVENT);
	  lValidTouch &= ~((1<<ELECTRODE1));
  }
  ...
  {
    	_lwevent_set(&lwevent_group, TOUCH3_EVENT);    
    lValidTouch &= ~((1<<ELECTRODE2));
  }
  ...
  {
	  _lwevent_set(&lwevent_group, TOUCH4_EVENT);   
    lValidTouch &= ~((1<<ELECTRODE3));
  }
